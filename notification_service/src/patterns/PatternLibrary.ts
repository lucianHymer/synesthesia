    ...
    const patterns: PatternWithMetadata[] = [
      {
        animation: {
          ...
          audio: [
            ...
            { start_ms: 200, duration_ms: 300, frequency: 659, voice: 0, waveform: "square" }
          ]
        },
        metadata: {
      ...
      },
      {
        animation: {
          ...
          audio: [
            { start_ms: 0, duration_ms: 200, frequency: 880, voice: 0, waveform: "square" },
            { start_ms: 1000, duration_ms: 200, frequency: 880, voice: 0, waveform: "square" }
          ]
        },
        metadata: {
          id: "urgent_alert_v1",
      ...
      },
      {
        animation: {
          ...
          audio: [
            { start_ms: 0, duration_ms: 500, frequency: 523, voice: 0, waveform: "square" },
            { start_ms: 500, duration_ms: 500, frequency: 659, voice: 0, waveform: "square" },
            { start_ms: 1000, duration_ms: 500, frequency: 784, voice: 0, waveform: "square" },
            { start_ms: 1500, duration_ms: 1000, frequency: 1047, voice: 0, waveform: "square" }
          ]
        },
        metadata: {
          id: "celebration_milestone_v2",
          description: "Rainbow colors with ascending victory melody",
          tags: ["celebration", "milestone", "achievement", "rainbow", "victory"],
          typical_use: "major releases, project completion, significant achievements",
          intensity: "high",
      ...
      },
      {
        animation: {
          ...
          audio: [
            { start_ms: 0, duration_ms: 300, frequency: 440, voice: 0, waveform: "square" }
          ]
        },
        metadata: {
      ...
      },
      {
        animation: {
          ...
          audio: [
            { start_ms: 0, duration_ms: 400, frequency: 698, voice: 0, waveform: "square" },
            { start_ms: 1000, duration_ms: 400, frequency: 740, voice: 0, waveform: "square" }
          ]
        },
        metadata: {
      ...
      },
      {
        animation: {
          ...
          audio: [
            { start_ms: 0, duration_ms: 200, frequency: 349, voice: 0, waveform: "square" }
          ]
        },
        metadata: {
          id: "info_subtle_v1",
          ...
          typical_use: "information messages, status updates, general notifications",
          intensity: "low",
          mood: "informative",
          usage_count: 0,
      ...
      },
      {
        animation: {
          ...
          audio: [
            { start_ms: 0, duration_ms: 100, frequency: 293, voice: 0, waveform: "square" },
            { start_ms: 1000, duration_ms: 100, frequency: 330, voice: 0, waveform: "square" },
            { start_ms: 2000, duration_ms: 100, frequency: 370, voice: 0, waveform: "square" },
            { start_ms: 3000, duration_ms: 100, frequency: 392, voice: 0, waveform: "square" }
          ]
        },
        metadata: {
      ...
      },
      {
        ...
        metadata: {
          ...
          typical_use: "long-running processes, waiting states, background tasks",
          intensity: "low",
          mood: "patient",
          usage_count: 0,
      ...
      },
      {
        animation: {
          ...
          audio: [
            { start_ms: 0, duration_ms: 300, frequency: 220, voice: 0, waveform: "square" },
            { start_ms: 0, duration_ms: 300, frequency: 233, voice: 1, waveform: "square" }
          ]
        },
        metadata: {
      ...
      },
      {
        animation: {
          ...
          audio: [
            { start_ms: 500, duration_ms: 200, frequency: 523, voice: 0, waveform: "square" },
            { start_ms: 700, duration_ms: 200, frequency: 659, voice: 0, waveform: "square" },
            { start_ms: 900, duration_ms: 200, frequency: 784, voice: 0, waveform: "square" },
            { start_ms: 1100, duration_ms: 400, frequency: 1047, voice: 0, waveform: "square" }
          ]
        },
        metadata: {
          ...
          typical_use: "major test suite passes, successful deployments, big wins",
          intensity: "high",
          mood: "triumphant",
          usage_count: 0,
